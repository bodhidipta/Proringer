...
public class SetGetChatPojoData {
    private String date = "";
    ...
    public SetGetChatPojoData(String date, boolean isDateVisible, String message, boolean sender, boolean ismessage, String imageLink) {
        this.date = date;
