...
import com.android.llc.proringer.activities.ContactProServiceActivity;
...
public class CustomListAdapterDialog extends RecyclerView.Adapter<CustomListAdapterDialog.MyViewHolder> {
    ...
    ContactProServiceActivity.onOptionSelected callback;

    public CustomListAdapterDialog(Context mContext, JSONArray predictionsJsonArray, ContactProServiceActivity.onOptionSelected callback) {
